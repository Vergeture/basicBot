...
(function () {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            "Tel que je le vois, oui.",
            "Tape moins fort sur ton clavier, j'ai pas compris.",
            "Concentre-toi et répètes.",
            "Je ne pense pas.",
            "J'en suis pas sûr.",
            ...
            "Demandes à Google.",
            "Nope. Non vraiment non.",
            "Tu va devoir attendre.",
            "J'ai des doutes.",
            "M'ouais ça va.",
            "Je pense que oui!",
            "Qui sait ?",
        ...
        commands: {
            ...
            cookieCommand: {
                ...
                rank: 'user',
                type: 'startsWith',
                cookies: ['t\'a donné un vieux cookie Eco+ !',
                    't\'a donné un cookie au chocolat encore tout chaud !',
                    't\'a donné le dernier cookie au fond du paquet, dégeulasse.',
                    't\'a donné un cookie au sucre. Quoi ? Pas de glaçage ? Même avec des gants Mappa j\'y touches pas',
                    't\'a donné un cookie... avec des raisins ? BERK !',
                    't\'a donné un cookie alien. Quand tu le touches, il fait des bébés cookies. Etrange.',
                    't\'a donné un Fortune cookie. Il y a marqué "Pourquoi tu ne fais pas autre chose ?"',
                    't\'a donné un Fortune cookie. Il y a marqué "Attention, ce message ne se mange pas !"',
                    't\'a donné un Fortune cookie. Il y a marqué "Tu as grossi depuis la dernière fois non ?"',
                    't\'a donné un Fortune cookie. Il y a marqué "Sort un peu dehors"',
                    't\'a donné un Fortune cookie. Il y a marqué "N\'oublies pas de manger tes légumes"',
                    't\'a donné un Fortune cookie. Il y a marqué "On voit très bien que tu ne fais pas de muscu\'"',
                    't\'a donné un Fortune cookie. Il y a marqué "Ethernal te regarde dormir. Tous les soirs"',
                    't\'a donné un Fortune cookie. Il y a marqué "Ne fait pas confiance à la personne qui t\'a donné ce cookie"',
                    't\'a donné un Fortune cookie. Il y a marqué "Je t\'aime !"',
                    't\'a donné un cookie en or, c\'est bien beau mais tu ne peux pas le manger... Merde.',
                    't\'a donné un oreo avec un verre de lait. Génial!',
                    't\'a donné un cookie arc-en-ciel fait avec amour :heart:',
                    't\'a donné le cookie angélique. En mordant dedans tu deviens un demi-dieu',
                    'ne sais pas cuisiner, donc pas de cookies.'
                ],
                getCookie: function () {
